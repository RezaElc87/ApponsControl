...
STDMETHODIMP CDTDisplay::put_ImgWidth(ULONG newVal)
{
...
STDMETHODIMP CDTDisplay::get_ImgHeight(ULONG* pVal)
{
	// TODO: Add your implementation code here
	*pVal = m_Height;
	return S_OK;
...
STDMETHODIMP CDTDisplay::put_ImgHeight(ULONG newVal)
{
	// TODO: Add your implementation code here
	m_Height = newVal;
	return S_OK;
}
STDMETHODIMP CDTDisplay::get_ImgWidth(ULONG* pVal)
{
	// TODO: Add your implementation code here
	*pVal = m_Width;
	return S_OK;
...
STDMETHODIMP CDTDisplay::get_DisplayScale(LONG* pVal)
{
	// TODO: Add your implementation code here
	*pVal = m_Scale;
	return S_OK;
...
STDMETHODIMP CDTDisplay::put_DisplayScale(LONG newVal)
{
	// TODO: Add your implementation code here
	m_Scale = newVal;
	SetScale();
...
STDMETHODIMP CDTDisplay::Repaint(void)
{
    //Do LUT
	if(m_bOpened) {
...
STDMETHODIMP CDTDisplay::get_ObjectHandle(IUnknown** pVal)
{
	// TODO: Add your implementation code here
...
LRESULT CDTDisplay::OnRefresh(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	if(m_bOpened)
	{
